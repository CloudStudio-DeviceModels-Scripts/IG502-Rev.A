...
# Parsing + Configuration Script – IG502 - Rev. A

This **Parsing + Configuration** script is designed for the **IG502** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – IG502 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **IG502** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
